...
<head>
	<meta charset="utf-8">
	<title>Ocean Pacific Shipping - Sign up</title>
						...
						<form action="./handler/auth.handler.php" method="post">
							<div class="space-y-4">
								...
								<div>
									...
									<input id="username" name="username" class="form-input w-full" />
								</div>
							...
							<div class="flex items-center justify-between mt-6">
								<button class="btn bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap" name="signup">Sign Up</button>
							</div>
						</form>
						<div class="pt-5 mt-6 border-t border-gray-200">
							<div class="text-sm">Have an account? <a class="font-medium text-indigo-500 hover:text-indigo-600" href="signin.html">Sign
									In</a></div>
						</div>
					</div>
				</div>
