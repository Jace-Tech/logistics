            ...
            <form action="./handler/parcel.handler.php" method="POST">
              ...
              <div class="grid grid-cols-12 w-full gap-4">
                <div class="col-span-full">
                  ...
                  <input type="text" name="title" id="title" placeholder="eg: Muskettes Biscuits" class="form-input w-full" required>
                </div>

                <div class="col-span-full sm:col-span-6">
                  <label for="account" class="mb-1 font-bold flex text-xs text-gray-500" for="id">Parcel ID *</label>
                  <div class="relative">
                    <input id="id" class="form-input w-full pr-8" name="id" placeholder="eg: OCP167874803151813895" required>
                ...
                <div class="col-span-full sm:col-span-6">
                  ...
                  <input type="text" name="weight" id="weight" placeholder="eg: 1 lbs / 0.45 kgs " class="form-input w-full" required>
                </div>

                <div class="col-span-full sm:col-span-6">
                  <label for="totalPieces" class="mb-1 font-bold flex text-xs text-gray-500">Total Pieces *</label>
                  <input type="number" name="totalPieces" id="totalPieces" placeholder="eg: 1" class="form-input w-full" required>
                </div>

                <div class="col-span-full sm:col-span-6">
                  <label for="dimensions" class="mb-1 font-bold flex text-xs text-gray-500">Dimensions *</label>
                  <input type="text" name="dimensions" id="dimensions" placeholder="eg: 19x21x1 in." class="form-input w-full" required>
                </div>

                <div class="col-span-full sm:col-span-6">
                  <label for="packaging" class="mb-1 font-bold flex text-xs text-gray-500">Packaging</label>
                  <input type="text" name="packaging" id="packaging" placeholder="eg: Your Packaging" class="form-input w-full">
                </div>
                ...
                <div class="col-span-full sm:col-span-6">
                  ...
                  <input type="datetime-local" name="date" id="date" placeholder="eg: 01/01/2023 12:00" class="form-input w-full" required> 
                </div>
              </div>
              ...
              <div class="grid grid-cols-12 w-full gap-4">
                ...
                <div class="col-span-full sm:col-span-6">
                  ...
                  <input type="text" name="terms" id="terms" placeholder="eg: Shipper" required class="form-input w-full">
                </div>

                <div class="col-span-full sm:col-span-6">
                  <label for="SpecialHandlingSection" class="mb-1 font-bold flex text-xs text-gray-500">Special Handling Section *</label>
                  <input type="text" name="specialHandlingSection" id="SpecialHandlingSection" placeholder="eg: Deliver Weekday " required class="form-input w-full">
                </div>
                ...
                <div class="col-span-full sm:col-span-6">
                  ...
                  <input required type="datetime-local" name="estimatedDate" id="estimatedDate" placeholder="eg: Deliver Weekday " class="form-input w-full">
                </div>
              </div>
